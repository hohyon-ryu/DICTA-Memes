...
Ranking the meme clusters based upon their meaningfulness or informativeness as described above is a difficult and largely subjective task, making it difficult to perform with machine learning.  For this reason, we are implementing an Amazon Mechanical Turk that will ask users to answer a set of basic yes/no questions about sample meme clusters to determine their meaningfulness.   
  Users will be asked questions such as "Is this a meaningful chunk of information?" and "Is this a common expression that could potentially appear elsewhere?" for approximately 1500 meme clusters in order to build a training set of memes that we can input into the Support Vector Machine for automatic meme ranking.

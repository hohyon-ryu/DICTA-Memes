...
\begin{itemize}
\item Hohyon Ryu: Meme Extraction, Meme Tracking
\item Jae Hyeon Bae: Clustering Memes, Scalability Issues
\item Nicholas Woodward: Theoretical Background, Meme Tracking, Practical Application
\end{itemize}
\subsection{Timeline}

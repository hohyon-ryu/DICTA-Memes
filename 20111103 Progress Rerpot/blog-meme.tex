...
We will use Support Vector Machine for meme ranking. Armed with LIBSVM package, we will learn C-SVM and regard each probability value as the ranking score. For better performance, we should scale feature values and use grid search to find suitable parameters.

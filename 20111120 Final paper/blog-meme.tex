...
For the purposes of extracting memes, HTML tags were removed and all text was HTML tags were preserved separately for later use, because this document collection will be used to present the blog post in a web interface. For the purposes of extracting memes , However, as meme extraction only requires text, a duplicate copy of the data collection  was created with the HTML stripped and lowercased. The test collection for meme extraction became 43GB after stripping HTML tags with Python Beautifulsoup.

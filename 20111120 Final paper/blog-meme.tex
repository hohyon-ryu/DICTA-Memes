...
Our work is related with finding information from the large scale corpus. Clustering algorithm is the basic data mining tool for discovering topics in document collection \cite{Jayabharathy2011}. In information retrieval, clustering have a wide range of application including search result clustering, scatter-gather, collection clustering, and cluster-based retrieval \cite{Manning2008}. Clustering can aggregate dispersed information and help clarify how to find access points for information in the large scale corpus.

[learning to rank]
Recently, there are various ranking algorithms. RankNet \cite{Burges2005} is based on pairwise preference and uses neural net to learn ranking functions. McRank \cite{
